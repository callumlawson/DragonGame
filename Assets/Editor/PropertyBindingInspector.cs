...
public class PropertyBindingInspector : Editor {
    ...
    [SerializeField]
    private string[] _sourcePropertiesNames;
    [SerializeField]
    private string[] _targetPropertiesNames;

    [SerializeField]
    private List<PropertyInfo> _sourceProperties = new List<PropertyInfo>();
    [SerializeField]
    private List<PropertyInfo> _targetProperties = new List<PropertyInfo>();
