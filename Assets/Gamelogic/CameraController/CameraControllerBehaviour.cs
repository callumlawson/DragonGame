...
namespace Assets.Gamelogic.CameraController
{
...
//    private const int LevelArea = 100;
        ...
        void Update()
        {
            ...
            var pan = ourCamera.transform.eulerAngles.x - zoomDelta * PanSpeed;
            pan = Mathf.Clamp(pan, PanAngleMin, PanAngleMax);
            if (zoomDelta < 0 || ourCamera.transform.position.y < (ZoomMax / 2))
            {
                ourCamera.transform.eulerAngles = new Vector3(pan, 0, 0);
            }
...
//                }
            ...
            var desiredPosition = ourCamera.transform.position + translation;
...
//        }
            ...
            ourCamera.transform.position += translation;
        }
    }
}
